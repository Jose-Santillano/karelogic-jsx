<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div x-data="{ show: false}">
            ...
            <input id="password" class="block w-full border-black border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
        ...
        <!-- Confirm Password -->
        <div x-data="{ show: false}">
            <x-input-label class="inline relative top-4 left-4 bg-white px-1" for="password_confirmation" :value="__('Confirm Password')" />

            <input  id="password_confirmation" class="block w-full border-black border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                            :type="show ? 'text' : 'password'"
