...
finalizar-programa</textarea
    ...
    <!-- Hidden elements -->
    <div>
      <img id="k-e" src="./img/karel_east.png" alt="" srcset="" hidden>
      <img id="k-w" src="./img/karel_west.png" alt="" srcset="" hidden>
      <img id="k-n" src="./img/karel_north.png" alt="" srcset="" hidden>
      <img id="k-s" src="./img/karel_south.png" alt="" srcset="" hidden>
    </div>
